let productsModel,formidable;_417‍.w("./products.model",[["default",["productsModel"],function(v){productsModel=v}]]);_417‍.w("formidable",[["default",["formidable"],function(v){formidable=v}]]);const path = require("path");
...
class UsersController {
  async getProducts(request, response, next) {
    try {
      const dataRes = await productsModel.getProducts();
  ...
  async createProducts(request, response, next) {
    try {
      let dataRes;
  ...
  async getUserProductsId(request, response, next) {
    try {
  ...
  async updateProductsWithId(req, res, next) {
    try {
  ...
  validateProductsBody(request, response, next) {
  ...
  aggregateBodyForCreateProductsWithImage(req, res, next) {
